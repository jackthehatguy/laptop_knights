...
class Box {
  constructor(x, y, width, height, display) {
...
class Animation {
  constructor(width, height, src, num_frames, delay) {
    this.width = width;
    this.height = height;
  ...
  draw(x, y) {
    ...
    //   this.frames.height
    // );
    c.drawImage(this.frames, this.cur_frame * this.width, 0, this.width, this.height, x, y, this.width, this.height);
  }
}
