TextureRenderable.prototype.setColorArray = function () {
  if (this.mColorArray === null) this.mColorArray = gEngine.Textures.getColorArray(this.mTexture);
};
...
TextureRenderable.prototype._wcPositionToIndex = function (returnIndex, wcPos) {
  ...
  // xForm.getPosition() returns center! texture origin is lower-left corner
...
TextureRenderable.prototype.pixelTouches = function (other, wcTouchPos) {
  ...
  // TODO: fix ugly!!!
  var xIndex = 0, yIndex; // is this a comma operator?! so, this is declaring it without assigning it?
  var otherIndex = [0, 0];
